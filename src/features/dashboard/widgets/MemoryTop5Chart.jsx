...
import { getMemoryTop5 } from '@/api/dashboard/dashboard';
...
export default function MemoryTop5Chart() {
    ...
    const loadMemoryTop5 = async () => {
        try {
            const result = await getMemoryTop5(period);
            ...
            console.error('MEMORY TOP5 장비 조회 실패', err);
            showError(MESSAGES.SERVER_ERROR);
        }
    };
    ...
    useEffect(() => {
        ...
        const root = am5.Root.new('memoryTop5Chart');
    ...
    return (
        <div className="w-full">
            <div className="flex justify-between items-center mb-2">
                <h2 className="text-lg font-semibold">MEMORY 사용률 TOP5</h2>
            ...
            <div id="memoryTop5Chart" className="w-full h-[320px]" />
